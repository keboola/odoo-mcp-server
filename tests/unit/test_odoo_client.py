...
class TestEmployeeToolsWithMocking:
    ...
    async def test_get_my_leave_balance_mocked(self, mock_odoo_client):
        ...
        # Mock allocations that are active during 2026
        ...
        # Verify search_read was called with correct domain (active during year filter)
        ...
        # Domain includes: employee_id, state, date_from <= year_end, and OR for date_to
        domain = call_args[1]["domain"]
        assert ["employee_id", "=", 1] in domain
